...
5. Rename the extracted folder from `super-data-analytics-main` to `super-data-analytics`.
6. Copy the renamed `super-data-analytics` folder into your agent's skills directory.
...
This repository is the `super-data-analytics` skill. Keep the full `super-data-analytics` folder together when installing it.
